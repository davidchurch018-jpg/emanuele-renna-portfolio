      ...
      <div className="relative">
        ...
        {isOn && (
          <motion.div
            ...
            animate={{ 
              opacity: [0.3, 0.6, 0.3],
              boxShadow: [
                "0 0 20px rgba(168, 255, 0, 0.3), 0 0 40px rgba(168, 255, 0, 0.1)",
                "0 0 30px rgba(168, 255, 0, 0.5), 0 0 60px rgba(168, 255, 0, 0.2)",
                "0 0 20px rgba(168, 255, 0, 0.3), 0 0 40px rgba(168, 255, 0, 0.1)"
              ]
            }}
        ...
        <button
          ...
          className={cn(
            ...
            sizeClasses[size],
            isOn
              ? "bg-gradient-to-r from-[#A8FF00] to-[#90e600] shadow-[0_0_30px_rgba(168,255,0,0.5)]"
        ...
        >
          ...
          >
            ...
            >
              {isOn ? (
                <Zap className={cn(iconSizes[size], "text-[#0a0a0a] fill-[#E8EAED]")} />
              ) : (
          ...
          {isOn && (
            <motion.div
              ...
              animate={{ 
                opacity: 1,
                background: [
                  "radial-gradient(circle at 70% 50%, rgba(232, 234, 237, 0.4) 0%, transparent 50%)",
                  "radial-gradient(circle at 75% 50%, rgba(232, 234, 237, 0.5) 0%, transparent 60%)",
                  "radial-gradient(circle at 70% 50%, rgba(232, 234, 237, 0.4) 0%, transparent 50%)"
                ]
              }}
